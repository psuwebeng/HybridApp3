  ...
  <div class="centered-container">
    <md-content class="md-elevation-3">
      ...
      <div class="title">
        ...
        <div class="md-body-1">Please sign up.</div>
      </div>
      ...
      <div class="form">
        ...
        <md-field md-has-password>
          ...
          <md-input name="confirmpassword" id="confirmpassword" v-model="login.confirmpassword" type="password" required :rules="[comparePasswords]"></md-input>
        </md-field>
      </div>

      <div class="actions md-layout md-alignment-center">
        <md-button class="md-raised md-primary" @click="userSignUp">Sign Up</md-button>
      </div>
